 ...
 *
 * The walk lives in fasync_shared.h so that this half and the memory-safe half
 * cannot drift apart: it used to be written out twice, once per toolchain, and
 * the negative-range memo added to it would have had to be kept in step by hand.
 * See the comments there for why the memo exists and what proves it safe.
 */
